...
public:
  ...
  void render(const std::string& text_link, const std::string& data) const {
    std::cout << "<a href=" << text_link << "/>";
    text_->render(data);
    std::cout << "</a>";
  }
};
...
int main() {
  ...
  auto text_block_4 = new Reversed(new Text());
  text_block_4->render("Hello world");
}
